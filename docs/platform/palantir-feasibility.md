...
3. [ ] Media-set creation, catalog-level model state, normalized object/link resources, the synthetic timestamp transform path, and bounded GeoTIFF ingestion are confirmed. Ontology-backed map tiling and OSDK/static-hosting configuration remain open.
