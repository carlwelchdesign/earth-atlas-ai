...
- [ ] JSON Schemas cover manifest, acquisitions, candidates, assessments, and optional draft summary.
- [ ] Valid, stale-version, missing-artifact, partial-success, and malicious-path fixtures exist.
- [ ] Small licensed demo bundle is checked in or generated by a bounded fixture script.
- [ ] Bundle documentation includes compatibility and migration rules.
