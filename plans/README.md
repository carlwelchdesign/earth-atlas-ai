...
Status: EAT-001 through EAT-011, EAT-DES-001, and EAT-014 through EAT-031 are complete. EAT-032 is validating the Nepal release candidate and EAT-033 owns release. EAT-012 remains in qualified review and adjudication, so EAT-013 and M3 remain gated. EAT-020 removed the retired proprietary-platform experiment; EchoAtlas has no Palantir or ontology dependency.
